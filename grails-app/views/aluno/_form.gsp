...
<div class="fieldcontain ${hasErrors(bean: alunoInstance, field: 'dataCadastro', 'error')} required">
    <label for="dataCadastro">
        <g:message code="aluno.dataCadastro.label" default="Data Cadastro"/>
        <span class="required-indicator">*</span>
    </label>
...
<div class="fieldcontain ${hasErrors(bean: alunoInstance, field: 'status', 'error')} ">
    <label for="status">
        <g:message code="aluno.status.label" default="Status"/>

    </label>
    <g:checkBox name="status" value="${alunoInstance?.status}"/>
